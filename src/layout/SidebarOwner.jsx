...
const SidebarOwner = () => {
  ...
  const menuItems = [
    { name: "Overview", path: "/admin", Icon: HiOutlineTemplate },
    { name: "Manajemen Kamar", path: "/admin/kamar", Icon: HiOutlineOfficeBuilding },
    { name: "Data Penghuni", path: "/admin/penghuni", Icon: HiOutlineUserGroup },
    { name: "Keuangan Kos", path: "/admin/keuangan", Icon: HiOutlineCash },
    { name: "Pengaduan", path: "/admin/pengaduan", Icon: HiOutlineClipboardList },
    { name: "Kelola Informasi", path: "/admin/informasi", Icon: HiOutlineDocumentText }
  ];
    ...
    <aside className="w-64 bg-[var(--color-tertiary)] border-r border-[var(--color-primary-light)] flex flex-col h-screen sticky top-0 shrink-0">
      <Link to="/" className="p-6 border-b border-[var(--color-primary-light)] flex items-center gap-3 hover:opacity-90 transition">
        ...
        <div>
          ...
          <p className="text-[9px] text-[var(--color-accent-text)]/40 uppercase tracking-wider font-sans font-bold">Owner Dashboard</p>
        </div>
      </Link>
